...
(cl:defmethod result-val ((m <calculateDistance-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader pose_robot_statistics2d-srv:result-val is deprecated.  Use pose_robot_statistics2d-srv:result instead.")
  (result m))
